...
\begin{itemize}
	...
	\item $g(\Delta) = 1$ as order of $\Delta$ decrease \ref{orderDecrease}
	
	\item $g(\Delta^3) = 2$ as $T_3|\Delta^3 = \Delta \implies g(\Delta^3) > 1$ and order of $\Delta$ decrease gives $g(\Delta^3) \leq 2$
	\item $g(\Delta^3+\Delta) = 2$ similarly
	
	\item $g(\Delta^5) = 2$ as $T_p|\Delta^5 = \Delta \text{ or } 0 \implies g(\Delta^5) \leq 2$ and $T_5|\Delta^5 = \Delta \implies g(\Delta^5) \geq 2$
	\item $g(\Delta^5+\Delta^3+\Delta) = g(\Delta^5+\Delta^3) = g(\Delta^5+\Delta) = 2$ similarly
