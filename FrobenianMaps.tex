...
The reason why it is reasonable to take only $\alpha$ of such a form follows from \cite{bellaiche}, as mentioned by Nicholas and Serre in \cite{StructureAlgebreHecke}: one can take the governing fields to be unramified outside $2$ and infinity and to have Galois groups that are $2$-groups.
