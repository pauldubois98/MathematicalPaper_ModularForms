...
\end{theorem}
[here, what paper do I cite? Bellaiche's "une représentation Galoisienne universelle attachée aux formes modulaires modulo 2?]
...
\paragraph{Notations}
We denote $M_{ij}$ the first governing field of the map $p \to a_{ij}(p)$ From the theorem above, we know that such a field exist, the first means that we take the one with smallest degree extension.
...
[other properties following from Frobenius properties?]
...
\paragraph{Examples}
[include from comp + link to table for more]
